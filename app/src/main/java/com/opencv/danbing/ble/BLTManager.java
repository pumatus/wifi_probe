	...
	private BroadcastReceiver searchDevices = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				//XC_MAC0013  20:17:04:12:94:38
//				if (device.getName().contains("XC_MAC0013")) {
//					if (device.getBondState() == BluetoothDevice.BOND_NONE) {
//						try {
//							ClsUtil.createBond(device.getClass(), device);
//						} catch (Exception e) {
//							e.printStackTrace();
//						}
//					}
...
//				if (device.getName().equals("XC_MAC0013")) {
//					try {
//						ClsUtil.setPairingConfirmation(device.getClass(), device, true);
//						Log.i("order...", "isOrderedBroadcast:"+isOrderedBroadcast()+",isInitialStickyBroadcast:"+isInitialStickyBroadcast());
//						abortBroadcast();
//						boolean ret = ClsUtil.setPin(device.getClass(), device, "1234");
////						Intent intent1 = new Intent(BLTApplication.class, BLTListActivity.class);
...
//				}
	...
	private void connect(BluetoothDevice btDev, Handler handler) {
		try {
			...
			if (mBluetoothSocket != null)
				...
				BLTApplication.bluetoothSocket = mBluetoothSocket;
	...
	public void checkBleDevice(Context context) {
		if (getmBluetoothAdapter() != null) {
			...
			Toast.makeText(context, "该手机不支持蓝牙", Toast.LENGTH_LONG).show();
		}
	}
